...
<!-- JQuery DatePicker 사용을 위한 JS 파일 -->
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>  
<!-- jQuery-UI 라이브러리 JS 파일 -->
<script src="http://code.jquery.com/ui/1.8.18/jquery-ui.min.js"></script>
<!-- 회원 가입 폼 유효성 검사 Script -->
...
<script>
	$(function() {
		...
		//$('#testDatepicker').val($.datepicker.formatDate('yymmdd', new Date())); // 오늘날짜 셋팅 하기		
		  ...
		  // datepicker 아이콘(icon)
		$('.ui-datepicker-trigger').css({'cursor':'pointer', 'margin-left':'5px', 'padding': '5px 0'});
	});        
</script>
		...
		<table class="joinTable">
			...
			<tr class="control-group">
				...
				<td>
					...
					<button class="btn" id="idCheck">중복확인</button><em id="isPossible"></em>
					<input type="hidden" id="isDuplicated" value="true">
				</td>				
			</tr>
			<tr class="control-group">
				<td class="control-label"><label><em style="color: red">*</em>비밀번호</label></td>				
				<td><input type="text" id="password" name="password"><em id="isValid"></em></td>				
			</tr>			
			<tr class="control-group">
				<td class="control-label"><label><em style="color: red">*</em>생년월일</label></td>				
				<td>
					<!-- jquery UI DatePicker -->
			    	<input type="text" id="datePicker" name="firstSSN" placeholder="YYYYMMDD">
				</td>				
			</tr>
			<tr class="control-group">
				<td class="control-label"><label><em style="color: red">*</em>주민번호 뒤8자리</label></td>				
				<td><input type="text" name="secondSSN"></td>				
			</tr>
			<tr class="control-group">
				<td class="control-label"><label><em style="color: red">*</em>휴대전화</label></td>				
			...
			<tr class="control-group">
				...
				<td class="submit-btn">
					<input class="btn btn-submit" id="btn-submit"  type="button" value="등록">					
				</td>				
			</tr>
			<tr>
				<!-- 회원 가입 공지 -->
