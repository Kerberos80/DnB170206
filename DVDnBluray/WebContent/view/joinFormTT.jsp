...
<style type="text/css">
	...
	/* 회원가입 입력 테이블 */
	* { padding: 0; margin: 0 }
	.joinTable { /*border-collapse: collapse;*/ width: 729px; position: relative; top: 30px; left: 10%; font-size: 13px; } /* content 가로크기 1297px*/
	.joinTable, .joinTable tr, .joinTable td { /*border: 1px solid #bcbcbc;*/ }	
	.joinTable h1 { font-size: 22px; margin-bottom: 10px; }	
	
	/* 이용 약관 */
	.joinTable .agreement { border: 1px solid #ddd; padding: 15px 15px 10px 15px; border-radius: 5px; background: #f8f8f8; margin-bottom: 10px; }			
	.joinTable .agreement>.text { max-height: 200px; overflow: auto; }			
	.joinTable .agreement>.confirm { padding: 10px 0 0 0; margin: 10px 0 0 0; border-top: 1px dotted #ccc; }	
	
	/* 회원 가입 정보 입력 란 */
	.joinTable .control-group { height: 40px; } /* 입력란 row 의 높이 */	
	.joinTable input, .joinTable button/*[class="ui-datepicker-trigger"]*/ { vertical-align: middle; }
	.joinTable .control-label { text-align: right; padding-right: 20px;}
	.joinTable .control-label em { padding-right: 5px; }	
	.joinTable input[type="text"], .joinTable input[type="password"], .joinTable input[type="email"] { background-color: #ffffff; border: 1px solid #cccccc; height: 20px; padding: 4px 6px; color: #555555; width: 206px; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075); -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075); -moz-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075); transition: border linear 0.2s, box-shadow linear 0.2s; -webkit-transition: border linear 0.2s, box-shadow linear 0.2s; -moz-transition: border linear 0.2s, box-shadow linear 0.2s; -o-transition: border linear 0.2s, box-shadow linear 0.2s; }
	.joinTable .submit-btn { text-align: right; }	
